...
from esphome.components import binary_sensor, sensor, text_sensor, uart, climate, switch
...
ComfoAirComponent = comfoair_ns.class_("ComfoAirComponent",  # pylint: disable=invalid-name
                                       climate.Climate,
                                       cg.Component,
                                       uart.UARTDevice)
